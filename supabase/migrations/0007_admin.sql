-- Dashboard de administrador: métricas de población de toda la app (sin datos
-- de dinero). Función SECURITY DEFINER que agrega datos de TODOS los profes,
-- protegida: solo la ejecuta el admin (se valida el email contra el JWT).
